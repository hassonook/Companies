...
Route::post('/lookup/job',[LookupController::class, 'job'])->name('job');
Route::post('/lookup/profession',[LookupController::class, 'profession'])->name('profession');
...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::delete('/company-delete/{id}', [CompanyController::class, 'delete'])->name('company_delete');
    ...
    Route::delete('/employee-delete/{id}', [EmployeeController::class, 'delete'])->name('employee_delete');
    ...
    Route::delete('/approval-delete/{id}', [ApprovalController::class, 'delete'])->name('approval_delete');
...
Route::middleware(['auth', 'role:Admin'])->group(function () {
    ...
    Route::post('/user-change-password', [UserController::class, 'change'])->name('change_password');
