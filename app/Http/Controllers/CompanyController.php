...
class CompanyController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $request->validate([
            ...
            'company_logo' => 'required|file|mimes:jpg,jpeg,png,gif',
        ...
        return redirect()->route('companies')->with('success', 'User added successfully! ');
    }
    ...
    public function update(Request $request, $id){
        $company = Company::find($id);
        //dd($request->registration_id.' old: '.$company->registration_id);
        $request->validate([
            'company_name' => 'required',
            'company_name_ar' => 'required',
            'company_logo' => 'file|mimes:jpg,jpeg,png,gif',
            'owner_id' => 'required',
            'owner_phone' => 'required',
            'registration_id' => 'required',
            'reg_issue_date' => 'required',
            'reg_expire_date' => 'required',
            'reg_photo' => 'file|mimes:pdf,jpg,jpeg,png,gif',
            'commercial_id' => 'required',
            'com_issue_date' => 'required',
            'com_expire_date' => 'required',
            'com_photo' => 'file|mimes:pdf,jpg,jpeg,png,gif',
            'license_no' => 'required',
            'lic_issue_date' => 'required',
            'lic_expire_date' => 'required',
            'lic_photo' => 'file|mimes:pdf,jpg,jpeg,png,gif',
            'main_branch' => 'required',
            'business' => 'required',
            'company_address' => 'required',
            'email' => 'email',
