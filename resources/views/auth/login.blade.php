                    ...
                    <div class="card">
                        <div class="card-body p-0 auth-header-box">
                            <div class="text-center p-3">
                                ...
                                <p class="text-muted  mb-0">Sign in to continue to...</p>
                            </div>
                        </div>
                        <div class="card-body p-0">
                            <!-- Tab panes -->
                                <div class="tab-pane active  p-3" id="LogIn_Tab" role="tabpanel">
                                    ...
                                    @endif
                                    <form class="form-horizontal auth-form" method="POST" action="{{ route('login_submit') }}">
                                        @csrf
                                        <div class="form-group mb-2">
                                            <label class="form-label" for="username">Username</label>
                                            <div class="input-group">
                                                <input name="email" type="text" class="form-control @error('email') is-invalid @enderror" value="" id="username" placeholder="Enter Email" autocomplete="email" autofocus>
                                                @error('email')
                        ...
                        <div class="card-body bg-light-alt text-center">
                            <span class="text-muted d-none d-sm-inline-block">Hassona © <script>
