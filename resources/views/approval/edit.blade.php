                                        ...
                                        <select
                                            ...
                                            @foreach ($companies as $company)
                                                <option value="{{ $company->id }}"
                                                    @if ($approval->company_id == $company->id) selected @endif>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('vp_no') parsley-error @enderror" name="vp_no"
                                            type="text" value="{{ $approval->vp_no }}" id="vp_no">
                                        @error('vp_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('req_no') parsley-error @enderror" name="req_no"
                                            type="text" value="{{ $approval->req_no }}" id="req_no">
                                        @error('req_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('issue_date') parsley-error @enderror"
                                            name="issue_date" type="date" value="{{ $approval->issue_date }}"
                                            id="issue_date">
                                        @error('issue_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('expire_date') parsley-error @enderror"
                                            name="expire_date" type="date" value="{{ $approval->expire_date }}"
                                            id="expire_date">
                                        @error('expire_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-sm-10">
                                        <select
                                            ...
                                            @foreach ($nationalities as $code => $name)
                                                <option value="{{ $code }}"
                                                    @if ($approval->nationality_id == $code) selected @endif>{{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select
                                            ...
                                            @foreach ($job_titles as $job_title)
                                                <option value="{{ $job_title->id }}"
                                                    @if ($approval->job_title_id == $job_title->id) selected @endif>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input @error('gender') parsley-error @enderror"
                                                ...
                                                @if ($approval->gender == 'Male') checked @endif>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input @error('gender') parsley-error @enderror"
                                                ...
                                                @if ($approval->gender == 'Female') checked @endif>
                                            <label class="form-check-label"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('total') parsley-error @enderror"
                                            name="total" type="number" value="{{ $approval->total }}"
                                            id="total">
                                        @error('total')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('consumed') parsley-error @enderror"
                                            name="consumed" type="number" value="{{ $approval->consumed }}"
                                            id="consumed">
                                        @error('consumed')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
