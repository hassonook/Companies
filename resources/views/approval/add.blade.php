                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('vp_no') parsley-error @enderror" name="vp_no" type="text" value="{{ old('vp_no') }}" id="vp_no">
                                        @error('vp_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('req_no') parsley-error @enderror" name="req_no" type="text" value="{{ old('req_no') }}" id="req_no">
                                        @error('req_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('issue_date') parsley-error @enderror" name="issue_date" type="date" value="{{ old('issue_date') }}" id="issue_date">
                                        @error('issue_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('expire_date') parsley-error @enderror" name="expire_date" type="date" value="{{ old('expire_date') }}" id="expire_date">
                                        @error('expire_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="select2 form-control mb-3 @error('nationality_id') parsley-error @enderror" name="nationality_id" id="nationality_id" style="width: 100%">
                                            ...
                                            <option value="{{ $nationality->code }}" @if(old('nationality_id') == $nationality->code) selected @endif>{{ App::getLocale() == 'ar' ? $nationality->name_ar : $nationality->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('total') parsley-error @enderror" name="total" type="number" value="{{ old('total') }}" id="total">
                                        @error('total')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('consumed') parsley-error @enderror" name="consumed" type="number" value="{{ old('consumed') }}" id="consumed">
                                        @error('consumed')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
