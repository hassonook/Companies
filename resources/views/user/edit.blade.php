                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('name') parsley-error @enderror" name="name" type="text" value="{{ $user->name }}" id="name">
                                        @error('name')
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('email') parsley-error @enderror" name="email" type="email" value="{{ $user->email }}" id="email">
                                        @error('email')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('mobile_number') parsley-error @enderror" name="mobile_number" type="tel" value="{{ $user->mobile_number }}" id="mobile">
                                        @error('mobile_number')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    <label for="role"
                                        class="col-sm-2 form-label align-self-center mb-lg-0 text-end">Role</label>
                                    <div class="col-sm-10">
